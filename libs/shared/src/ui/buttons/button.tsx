...
export const Button: React.FC<ButtonProps> = ({ children, rounded=false, size = "md", variant = "primary", outlined = false, fullWidth = false,  tagType, className = "", link, ...rest }: ButtonProps ) => {
